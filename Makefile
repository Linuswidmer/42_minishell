...
#    Updated: 2023/07/05 19:04:15 by jstrotbe         ###   ########.fr        #
...
FILENAMES_JOB = min_buildin_cmd min_ex_get_cmd min_expander min_set_cmd min_common_cmd min_ex_io min_io_and_cmd min_set_io min_get_envp min_free_cmdnode min_checkpath min_ft_checkpath_cmd_is_path
...
FILENAMES_EXECUTER = min_executer min_exit_handler min_sub min_job min_route

FILENAMES_PIPE = min_pipe min_pipe_loop pipe_redirection
	
FILENAMES_FREE = min_free min_dfree free_token_list free_pipestruct free_minishell
