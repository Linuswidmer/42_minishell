...
/*   Updated: 2023/06/27 13:26:16 by lwidmer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#ifndef EXPANDER_H
# define EXPANDER_H
...
char		min_word(t_lexer **token, t_expander **word, char *value,
				char space);
...
char		min_asterisk(t_lexer **token, t_expander **word,
				t_expander *old, t_exphelp help);
char		min_gaam(t_lexer **token, t_expander **asterisk,
				t_expander **extra, t_dict *dict);
void		min_evaluate_asterisk(t_expander **word, t_expander *asterisk,
				char wo);
